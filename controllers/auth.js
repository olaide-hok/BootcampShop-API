...
exports.forgotPassword = asyncHandler(async (req, res, next) => {
    ...
    const message = `You are receiving this email because you (or someone else) has requested the reset of your password. Please make sure to make a PUt request to: \n\n ${resetUrl}`
